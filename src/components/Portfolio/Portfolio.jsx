    ...
    <motion.section
      ...
      <div className={`innerWidth flexCenter ${css.container}`}>
        ...
        <motion.div variants={textVariant(.4)} className={`flexCenter ${css.heading}`}>
          <div>
            <span className="primaryText">Mes Dernières Oeuvres</span>
            <p style={{ marginTop: "10px" }}>Solution parfaite pour l'experience numerique</p>
          </div>
          <span className="secondaryText">explorer plus d'oeuvres</span>
        </motion.div>
